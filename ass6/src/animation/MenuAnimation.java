...
public class MenuAnimation<T> implements Menu<T> {
    ...
    public MenuAnimation(String menuTitle, KeyboardSensor ks) {
        ...
        try {
            ...
            image2 = ImageIO
                    .read(ClassLoader.getSystemClassLoader().getResourceAsStream("background_images/title.png"));
            image3 = ImageIO.read(ClassLoader.getSystemClassLoader().getResourceAsStream("background_images/sub.png"));
            image4 = ImageIO.read(ClassLoader.getSystemClassLoader().getResourceAsStream("background_images/sub2.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void doOneFrame(DrawSurface d, double dt) {
        ...
        if (!listOfSubMenu.isEmpty()) {
            d.drawImage(d.getWidth() / 3, d.getHeight() / 6 + 50, image3);

        } else {
            d.drawImage(d.getWidth() / 3, d.getHeight() / 6 + 50, image4);
